...
const Hero = () => {
    ...
    const otterCard = [
        {
            image: 'https://www.digitalotters.com/wp-content/uploads/2024/05/ecommerce-SEO-icon.webp',
            title: "Ecommerce",
            description:
        ...
        {
            image: 'https://www.digitalotters.com/wp-content/uploads/2024/05/Healthcare-SEO-icon.webp',
            title: "Healthcare",
            description:
        ...
        {
            image: 'https://www.digitalotters.com/wp-content/uploads/2024/05/Real-Estate-SEO-Icon.webp',
            title: "Real Estate",
            description:
        ...
        {
            image: 'https://www.digitalotters.com/wp-content/uploads/2024/05/SaaS-SEO-Icon.webp',
            title: "SaaS Projects",
            description:
        ...
        {
            image: 'https://www.digitalotters.com/wp-content/uploads/2024/05/EdTech-SEO-icon.webp',
            title: "EdTech",
            description:
    ...
    return (
        <>
            ...
            {/* -----------------------------technology Section--------------------*/}
            <Box sx={{ backgroundColor: "#1976d2", height: 'auto', width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <Box sx={{
                    display: 'grid',
                    gridTemplateColumns: {
                        xs: 'repeat(2, 1fr)',
            ...
            <Box >
                <Box sx={{ width: { lg: "80%" }, margin: "0 auto", py: '20px' }}>
                    ...
                    >
                        With an experienced in-house development team, we operate as a web development agency focusing on frontend, backend, and full-stack development.
                    </Typography>
                </Box>
                <Box sx={{ display: "flex", width: { lg: "80%" }, margin: "20px auto", px: "20px" }}>
                    <Box sx={{ display: 'flex', flexDirection: { xs: 'column-reverse', lg: 'row' }, width: '100%', py: '20px', alignItems: { xs: ' ', lg: 'center' } }}>
                ...
                <Box sx={{ display: "flex", width: { lg: "80%" }, margin: "20px auto", px: "20px", }}>
                    <Box sx={{ display: 'flex', flexDirection: { xs: 'column', lg: 'row' }, width: '100%', py: '20px', alignItems: { xs: ' ', lg: 'center' }, gap: '100px' }}>
                        <Box sx={{ width: { lg: '50%' }, margin: '0 auto' }}>
                            <Box component="img" src="https://www.digitalotters.com/wp-content/uploads/2024/06/basckend-developers.webp" alt="" sx={{ width: { xs: '300px', lg: '500px' }, height: 'auto' }} />
                        </Box>
                        <Box sx={{ width: { lg: '50%' } }}>
                ...
                <Box sx={{ display: "flex", width: { lg: "80%" }, margin: "20px auto", px: "20px", }}>
                    <Box sx={{ display: 'flex', flexDirection: { xs: 'column-reverse', lg: 'row' }, width: '100%', py: '20px', alignItems: { xs: ' ', lg: 'center' }, gap: '100px' }}>
                        <Box sx={{ width: { lg: '50%' } }}>
