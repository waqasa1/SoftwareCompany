    ...
    <>
      ...
      >
        <Box sx={{ padding: "10px" }}>
          <img src={cost} alt="" />
          <Typography
            sx={{ color: "#0A0D31", fontSize: "20px", fontWeight: "700" }}
          >
            Cost-effectiveness
          </Typography>
          <Typography sx={{ fontSize: "12px", color: "#5F6567" }}>
      ...
      <Divider
        sx={{ width: "80%", margin: "0 auto", mb: "20px", py: "20px" }}
      />
                  ...
                  >
                    ...
                    >
                      <Box sx={{ display: "flex", alignItems: "center" }}>
                        <img
                          src="https://tecnologia.vamtam.com/wp-content/uploads/2023/03/photo-1581091878591-4f0714c6f32f-300x300.jpg"
                          alt="img"
                          style={{
                            height: "50px",
                            width: "50px",
