            ...
            <Box sx={{ backgroundColor: '#B3C9E7', py: '20px' }}>
                <Box sx={{ width: { lg: '80%' }, margin: '0 auto' }}>
                    ...
                    <Box sx={{ display: 'flex', justifyContent: 'center', marginTop: '20px' }}>
                        <Button variant='contained' sx={{ textTransform: 'none', ":hover": { backgroundColor: 'black' } }}>View All Solutions</Button>
                    </Box>

                </Box>
            </Box>
            {/*--------------------- What We Do small cards  Section ------------------*/}
            <Box sx={{ py: '20px' }}>
                <Box sx={{ width: { lg: '80%' }, margin: '0 auto' }}>
                        ...
                        <Box sx={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: 2, mt: 4 }}>
                            ...
                            <Box sx={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: 2 }}>
                                {[
                                    ...
                                    <Box key={index} sx={{ width: { xs: '100%-20px', lg: '32%' }, display: 'flex', justifyContent: 'center' }}>
                                        <Box sx={{ backgroundColor: 'rgb(235, 231, 231)', borderRadius: '100px', width: 'fit-content', height: '50px' }}>
                                            <Box sx={{ display: 'flex', alignItems: 'center' }}>
                                                <img src="https://tecnologia.vamtam.com/wp-content/uploads/2023/03/photo-1581091878591-4f0714c6f32f-300x300.jpg" alt="img" style={{ height: '50px', width: '50px', borderRadius: '50%' }} />
                                                <Typography sx={{ marginLeft: '20px', fontWeight: '700', paddingRight: '10px' }}>{text}</Typography>
                                            </Box>
                                        </Box>
                                    </Box>
                                ))}
