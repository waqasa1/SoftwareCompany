...
const HeroSection = () => {
    return (
        <>
            ...
            <Divider sx={{ py: '20px', width: '90%', margin: '0 auto', mb:'20px' }} />
            <Box sx={{ display: 'flex',  flexWrap: 'wrap',  width:{ lg:'80%'}, margin: '0 auto', justifyContent: 'center', paddingLeft:'10px', marginBottom:'50px' }}>
                ...
                <Divider sx={{ width: '90%', margin: '0 auto', mb:'20px', display:{xs:'block', lg:'none'} }} />
            ...
            <Box sx={{display:'flex',  width:{lg:'80%'}, margin:'0 auto', justifyContent:'space-between'}}>
                <Box>
                    <img src="https://tecnologia.vamtam.com/wp-content/uploads/2023/03/Cost-effectiveness.svg" alt="" />
                    <Typography>Cost-effectiveness</Typography>
                    <Typography sx={{fontSize:'14px', color:'#5F6567'}}>We offer affordable IT solutions that help you reduce costs and improve your bottom line.</Typography>
                </Box>
                 <Box>
                    <img src="https://tecnologia.vamtam.com/wp-content/uploads/2023/03/Cost-effectiveness.svg" alt="" />
                    <Typography>Innovative Technology</Typography>
                    <Typography sx={{fontSize:'14px', color:'#5F6567'}}>We stay up-to-date with the latest technology trends and offer innovative solutions that help you stay ahead of the competition.</Typography>
                </Box>
                 <Box>
                    <img src="https://tecnologia.vamtam.com/wp-content/uploads/2023/03/Cost-effectiveness.svg" alt="" />
                    <Typography>Scalability</Typography>
                    <Typography sx={{fontSize:'14px', color:'#5F6567'}}>Our solutions are scalable and can grow with your business, ensuring that you get the most value out of your investment.</Typography>
                </Box>
                 <Box>
                    <img src="https://tecnologia.vamtam.com/wp-content/uploads/2023/03/Cost-effectiveness.svg" alt="" />
                    <Typography sx={{color:'#0A0D31', fontSize:'24px'}}>Industry Expertise</Typography>
                    <Typography sx={{fontSize:'14px', color:'#5F6567'}}>We specialize in serving specific industries, such as healthcare, finance, or manufacturing, and offer tailored solutions that meet your unique needs.</Typography>
                </Box>
            </Box>
        </>
    )
