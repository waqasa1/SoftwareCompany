  ...
  const services = [
    {
      ...
      description:
        "Enterprise-grade web applications built with Laravel framework.",
      icon: <FaLaravel style={{ fontSize: "2.5rem", color: "#FF2D20" }} />,
      features: ["MVC architecture", "Eloquent ORM", "Blade templating"],
    },
    {
    ...
    },
    {
      ...
      description:
        "Upgrade and refactor older PHP codebases to modern standards.",
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Robust PHP solutions from WordPress to enterprise Laravel
            applications.
          </p>
        </div>
          ...
          {services.map((service, index) => (
            ...
            >
              <div
                style={{
                  fontSize: "2.5rem",
                  color: service.title.includes("Laravel")
                    ? "#FF2D20"
                    : "#777BB3",
                  marginBottom: "1.5rem",
                }}
